...
formatting. Please note sections \ref{AA}--\ref{SCM}
...
``Ref. \cite{b3}'' or ``reference \cite{b3}'' except
at the beginning of a sentence: ``Reference \cite{b3} was the
first $\ldots$''
...
\cite{b5}. Capitalize only the first word in a paper title, except
